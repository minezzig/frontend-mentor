    ...
    <section className="bg-gray-200 px-5 py-0">
      <div className="m-auto  max-w-[1024px] -translate-y-16">
        <form onSubmit={handleSubmit} className="w-full">
          <div className="mb-5 flex flex-col gap-5 rounded-lg bg-primary2 bg-[url('../assets/images/bg-shorten-mobile.svg')] p-5 md:flex-row md:bg-[url('../assets/images/bg-shorten-desktop.svg')] md:p-10">
